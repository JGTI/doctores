...
<html lang="es"dir="ltr">
  ...
  <head>
    ...
    <title>Engraveds | Tu evento comienza aquí: invita, celebra, recuerda</title>
    ...
    <meta name="msapplication-TileImage" content="assets/img/icono.png">
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="index.html">
            <div class="text-1000">Engra</div>
            <div class="text-danger">ved's</div>
           
          </a>
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              <li class="nav-item" data-anchor="data-anchor"><a class="nav-link fw-medium active" aria-current="page" href="#home">Dashboard</a></li>
            ...
            <form class="ps-lg-5">
                @auth
                    <button class="btn btn-lg btn-danger rounded-pill order-0" type="submit">{{Auth::user()->name}}</button>
                @endauth
                @guest
                     <a class="btn btn-lg btn-danger rounded-pill order-0" href="{{ route('login') }}">inicia sesión</a>
  ...
  <div class="row align-items-center py-8">
    <div class="col-md-5 col-lg-6 order-md-1 text-center text-md-end">
      <img class="img-fluid" src="assets/img/illustrations/mobile.png" width="350" alt="Mobile Illustration" />
    </div>
    <div class="col-md-7 col-lg-6 text-center text-md-start">
      <span class="badge bg-light rounded-pill text-dark align-items-center d-flex flex-row-reverse justify-content-end mx-auto mx-md-0 ps-0 w-75 w-sm-50 w-md-75 w-xl-50 mb-3">
        #1 Asistente Virtual de Diseño
        <img class="img-fluid float-start me-3" src="assets/img/illustrations/arrow-right.png" alt="Arrow Icon" />
      </span>
      <h1 class="mb-4 display-3 fw-bold lh-sm">Empieza tu evento  <span class="text-danger">creando invitaciones digitales "<span class='display-2'>GRATIS</span>"</span> <br class="d-block d-lg-none d-xl-block" />invita, celebra, y crea recuerdos inolvidables</h1>
      <p class="mt-3 mb-4 fs-1">Diseña invitaciones digitales que enamoren desde la primera mirada</p>
      <a class="btn btn-lg btn-danger rounded-pill hover-top" href="#" role="button">Empezar a diseñar gratis</a>
      <a class="btn btn-outline-danger rounded-pill  " href="#" role="button">Ver demos</a>
    </div>
  </div>
</div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-6 px-sm-5 px-md-0">
              ...
              <div class="d-flex align-items-center mb-5">
                ...
                <div class="px-4">
                  <h5 class="fw-bold text-danger">Prototyping</h5>
                  <p>Get your blood tests delivered at <br class="d-none d-xl-block"> home collect a sample from the <br class="d-none d-xl-block"> news your blood tests</p>
                </div>
              </div>
              <div class="d-flex align-items-center mb-5">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center text-md-start offset-md-1">
              ...
              <p class="my-4 pe-xl-5"> The rise of mobile devices transforms the way we consume information entirely and the world's most elevant channels such as Facebook.</p><a class="btn btn-lg btn-danger rounded-pill hover-top" href="#" role="button">Learn more</a>
            </div>
          </div>
        </div>
        <!-- end of .container-->
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-6 text-center text-md-start">
                ...
                </div><a class="btn btn-lg btn-danger rounded-pill hover-top" href="#" role="button">See all</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-4">
              <div class="card shadow-lg mb-4 border-0">
                ...
                <div class="card-body mx-auto">
                  ...
                  </ul><a class="btn btn-lg btn-danger rounded-pill mb-3" href="#">Start free trial</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card shadow-lg mb-4">
                ...
                <div class="card-body mx-auto">
                  ...
                  <div class="d-flex flex-column"> <a class="btn btn-lg btn-danger rounded-pill mb-3" href="#">Start free trial</a><a href="#">Or Start 14 days trail</a></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item mb-2">
                  ...
                  <div class="accordion-collapse collapse" id="collapse3" aria-labelledby="heading3" data-bs-parent="#accordionExample">
                    <div class="accordion-body bg-100">Disputed payments (also known as chargebacks) incur a $15.00 fee. If the customer鈥檚 bank resolves the dispute in your favor, the fee is fully refunded.</div>
                  </div>
                </div>
                <div class="accordion-item mb-2">
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-auto mb-5"><a class="pe-2 d-flex align-items-center text-decoration-none fw-bold fs-3" href="#">
                 <div class="text-1000 text-white">Engra</div>
            <div class="text-danger">ved's</div>
              </a></div>
          </div>
          <div class="row flex-center">
            <div class="col-auto mb-5">
              <ul class="list-unstyled list-inline mb-0">
                <li class="list-inline-item me3 me-sm-4"><a class="text-light text-decoration-none" href="#!">Dashboard</a></li>
 ...
 <a href="https://wa.me/4427068376?text=Hola%20engraveds,%20estoy%20interesado%20en%20tus%20servicios%20para%20realizar%20una%20invitacion,%20me%20podrías%20ayudar?" class="whatsapp-button" target="_blank">
