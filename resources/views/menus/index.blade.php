    ...
    <div class="row">
        ...
        <div class="card w-100">
            ...
            <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                ...
                <div>
                <button class="btn btn-success mb-2" data-bs-toggle="modal" data-bs-target="#menuModal" id="createNewMenu">Crear Nuevo Menú</button>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.editMenu', function () {
            ...
            $.get("{{ url('menus') }}" + '/' + menuId + '/edit', function (data) {
                ...
                $('#roles').val(JSON.parse(data.menu.roles));
                $('#order').val(JSON.parse(data.menu.order));
            });
        });
